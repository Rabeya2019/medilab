...
<div class="hero-wrap hero-bread set-bg" data-setbg="{{url('med/images/background6.jpg')}}">
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">MEDICINEHOME</a></span> <span>MEDICINES</span></p>
  ...
  <form class="d-flex" role="search">
    <input class="form-control me-2 fw-bold fs-4 rounded-pill" type="search" name="search" id="search" placeholder="Search" >
          ...
          <div class="row justify-content-center">
              ...
              <div class="col-md-10 mb-5 text-center">
                  <ul class="product-category">
                      ...
                      <li><a href="/firstaid">FIRSTAID</a></li>
