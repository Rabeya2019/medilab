...
<head>
    ...
    <link rel="stylesheet" href="{{ url('med/css/open-iconic-bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{ url('med/css/animate.css')}}">
    
    <link rel="stylesheet" href="{{ url('med/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{ url('med/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{ url('med/css/magnific-popup.css')}}">

    <link rel="stylesheet" href="{{ url('med/css/aos.css')}}">

    <link rel="stylesheet" href="{{ url('med/css/ionicons.min.css')}}">

    <link rel="stylesheet" href="{{ url('med/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{ url('med/css/jquery.timepicker.css')}}">

    
    <link rel="stylesheet" href="{{ url('med/css/flaticon.css')}}">
    <link rel="stylesheet" href="{{ url('med/css/icomoon.css')}}">
    <link rel="stylesheet" href="{{ url('med/css/style.css')}}">
</head>
