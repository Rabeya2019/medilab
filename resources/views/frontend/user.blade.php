            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="hero__text">
                        ...
                        <h2 style="color: rgb(17, 65, 17) ;">Take the world's best quality Treadment</h2>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="services__item">
                        ...
                        <div class="services__item__text">
                            <h5>Discount Service Packages</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor aliqua.</p>
                            <div class="col-lg-4 col-md-4 col-sm-6" >

                                    <a href="#" class="primary-btn" style="background-color: rgb(43, 158, 43); border: none; color: white;">Order</a>
